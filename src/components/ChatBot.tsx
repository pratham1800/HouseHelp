        ...
        {!isOpen && (
          <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            <motion.button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-primary to-accent px-5 py-3 rounded-full shadow-elevated hover:scale-105 transition-transform"
            >
            ...
            <motion.a
              ...
              className="flex items-center gap-2 bg-whatsapp px-5 py-3 rounded-full shadow-elevated"
            >
          ...
          >
            ...
            <div className="p-4 border-t border-border">
              ...
              <p className="text-xs text-muted-foreground text-center mt-2">
                Powered by AI • For urgent issues, contact WhatsApp
              </p>
            </div>
          </motion.div>
        )}
